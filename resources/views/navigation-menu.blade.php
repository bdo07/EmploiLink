                ...
                <div class="ms-3 relative">
                    ...
                    @guest
                        <div class="flex items-center space-x-3">
                            ...
                            <a href="{{ route('register') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-brand-600 hover:bg-brand-700 rounded-md shadow-soft">{{ __('Register') }}</a>
                        </div>
                    @endguest
                </div>
            </div>
